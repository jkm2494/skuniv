...
public class BoardController {
	...
	public String addShop(@RequestParam("snum") int snum, @RequestParam("score") int score,
			...
			@RequestParam("password") String password, @RequestParam("pid") String pid){
	...
	public String updateBoard(@RequestParam("boardnum") int boardnum, @RequestParam("snum") int snum, @RequestParam("score") int score,
			@RequestParam("btitle") String btitle, @RequestParam("bcontent") String bcontent,
			@RequestParam("password") String password, @RequestParam("pid") String pid){
		BoardVO board = new BoardVO();
