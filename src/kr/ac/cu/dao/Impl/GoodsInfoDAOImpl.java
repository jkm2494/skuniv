...
public class GoodsInfoDAOImpl implements GoodsInfoDAO {
	...
	@Override
	public GoodsInfoVO selectGoodsInfo(String id) throws RuntimeException {
		return (GoodsInfoVO)sqlSession.selectOne("kr.ac.cu.goods.selectgoodsInfo",id);
	}

	@Override
	public List<GoodsInfoVO> getGoodsInfoList() {
		return sqlSession.selectList("kr.ac.cu.goods.selectgoodsInfo" );
	}
